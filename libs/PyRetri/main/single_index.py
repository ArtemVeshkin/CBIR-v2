...
def main():
    ...
    path = '/home/artem/data/COCO/CBIR_data/CBIR_test/class/query/airplane/973_airplane_vehicle_0.9336.jpg'
    ...
    index_helper.save_topk_retrieved_images('/home/artem/data/COCO/CBIR_data/CBIR_test/class/retrieved_images/', index_result_info[0], 5, gallery_info)
